...
def inject_css(bg_base64_url=None):
    # On utilise l'URL web pour le fond général
    ...
    /* Fond d'écran général appliqué à tout le site */
    .stApp::before {{
    ...
    .stApp::after {{
        content: ""; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
        background-color: #000000; opacity: 0.70; z-index: -1;
    }}

    /* Styles Navbar, Boutons, Cards... */
    ...
    /* Style spécifique pour la bannière Hero */
