...
if st.session_state.current_page == "ACTEURS": 
    ...
    if hero_img_64:
        # Ajout du texte "LE CINÉMA QUI FAIT BATTRE LE CŒUR CREUSOIS" directement dans le Hero
        st.markdown(f'''
            <div style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('data:image/jpeg;base64,{hero_img_64}'); 
                ...
                <h1 style="font-size:3.5rem; font-weight:900; text-align:right; line-height:1.1; color: white !important; text-shadow: 2px 2px 15px rgba(0,0,0,0.6);">
    ...
    # --- SECTION FOCUS (TRAILER + INFOS ALIGNÉS) ---
